...
enum AUTH_CODE {
  ...
  BAD_OVERRIDE_C  = 0400,
  AUTH_MAIL_FROM_DEPRECATED_C = 01000
};
...
#define CLEAR_NOTIFY (MNT_NO_EXIST_C|DEL_NO_EXIST_C|NOOP_C|OTHER_FAIL_C|AUTH_FAIL_C|NEW_MNT_ERROR_C|DEL_MNT_ERROR_C|BAD_OVERRIDE_C|AUTH_MAIL_FROM_DEPRECATED_C)
#define CLEAR_FORWARD (MNT_NO_EXIST_C|DEL_NO_EXIST_C|NOOP_C|OTHER_FAIL_C|AUTH_PASS_C|NEW_MNT_ERROR_C|DEL_MNT_ERROR_C|BAD_OVERRIDE_C|AUTH_MAIL_FROM_DEPRECATED_C)
