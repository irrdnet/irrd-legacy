...
#define ROUTING_REGISTRY_OBJECTS (AUTNUM_F|ASMACRO_F|COMMUNITY_F|INET_RTR_F|MNTNER_F|ROUTE_F|AS_SET_F|ROUTE_SET_F|FILTER_SET_F|RTR_SET_F|PEERING_SET_F|KEY_CERT_F|REPOSITORY_F)
